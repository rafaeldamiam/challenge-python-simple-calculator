# Challenge—8 languages in 5 days (Python Code)
...
# How to execute this Python code
My enviroment was Ubuntu Mate 22.04, so I used apt to install this packages to be able to execute the Python code:

`apt-get install python3`

Then, go to the folder where the code is located and execute the code bellow to execute:
